...
namespace SaudaMaster.Web.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryID,StoreID,CategoryName,CategoryDisplayName,CategoryImage")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryID,StoreID,CategoryName,CategoryDisplayName,CategoryImage")] Category category)
        {
            if (ModelState.IsValid)
            {
